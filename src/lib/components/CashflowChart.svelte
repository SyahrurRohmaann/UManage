<script lang="ts">
  ...
  export let dataPoints: { date: number; income: number; expense: number }[] = [];
  ...
  function updateChart() {
    ...
    chart.data.labels = dataPoints.map(p => new Intl.DateTimeFormat('id-ID', { day: 'numeric', month: 'short' }).format(p.date));
